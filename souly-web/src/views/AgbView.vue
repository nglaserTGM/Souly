  ...
  <div class="legal-container">
    <div class="legal-box">
      ...
      <div class="legal-section">
        <h2>ÜBERSICHT</h2>
        <p>Diese Website wird von der iszhai GmbH betrieben. Überall auf der Webseite beziehen sich die Begriffe "wir", "uns" und "unsere/e" auf die iszhai GmbH. iszhai GmbH bietet diese Website, einschließlich aller Informationen, Tools und Dienste, die auf dieser Website verfügbar sind, Ihnen, dem Benutzer, unter der Bedingung an, dass Sie alle hier angegebenen Bedingungen, Konditionen, Richtlinien und Hinweise akzeptieren.</p>
        ...
        <h2>ABSCHNITT 3 - GENAUIGKEIT, VOLLSTÄNDIGKEIT UND RECHTZEITIGKEIT DER INFORMATIONEN</h2>
        ...
        <h2>ABSCHNITT 5 - PRODUKTE ODER SERVICELEISTUNGEN (falls zutreffend)</h2>
        ...
        <h2>ABSCHNITT 7 - ZUSÄTZLICHE TOOLS</h2>
        ...
        <h2>ABSCHNITT 8 - DRITTANBIETER-LINKS</h2>
        ...
        <h2>ABSCHNITT 9 - BENUTZERKOMMENTARE, FEEDBACK UND ANDERE EINSENDUNGEN</h2>
        ...
        <h2>ABSCHNITT 10 - PERSONENBEZOGENE DATEN</h2>
        ...
        <h2>ABSCHNITT 11 - FEHLER, UNGENAUIGKEITEN UND AUSLASSUNGEN</h2>
        ...
        <h2>ABSCHNITT 12 - VERBOTENE ANWENDUNGEN</h2>
        ...
        <h2>ABSCHNITT 13 - HAFTUNGSAUSSCHLUSS; HAFTUNGSBESCHRÄNKUNG</h2>
        ...
        <h2>ABSCHNITT 17 - GESAMTE VEREINBARUNG</h2>
        ...
        <h2>ABSCHNITT 18 - GELTENDES RECHT</h2>
        <p>Diese Allgemeinen Geschäftsbedingungen und alle separaten Vereinbarungen, in deren Rahmen wir Ihnen Serviceleistungen zur Verfügung stellen, unterliegen den Gesetzen von Gerhart-Hauptmann-Straße 21, Sankt Ingbert, 66386, Deutschland und sind nach diesen auszulegen.</p>

        <h2>ABSCHNITT 19 – ÄNDERUNGEN DER ALLGEMEINEN GESCHÄFTSBEDINGUNGEN</h2>
        ...
        <h2>ABSCHNITT 20 – KONTAKTDATEN</h2>
        <p>Fragen zu den Allgemeinen Geschäftsbedingungen sind unter [E-Mail Adresse] an uns zu richten.</p>
      </div>
    </div>
  </div>
</template>
